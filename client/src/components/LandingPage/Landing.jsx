...
function Landing() {
  ...
  <div className="left-section" data-aos="fade-left">
    <h1 className="heading-text"> <span style={{  background: 'linear-gradient(to right, #b38728, #dbd381, #aa771c)',
  WebkitBackgroundClip: 'text', // For webkit-based browsers
  color: 'transparent', // Set text color to transparent
  textFillColor: 'transparent' // For Firefox

, fontSize:'55px'}}> Empower your practice </span> Elevate your efficiency. Embrace the future of legal organization with our revolutionary app  where every case finds its perfect place.</h1>
  </div>
  ...
  <img className="client-image" src='https://i.pinimg.com/564x/25/36/99/253699cae1a7b81914689d8955695d5e.jpg' alt="Client" />
  </div>
</div>
      <div className="services" id="services"  >
        <h1 style={{fontFamily:'initial', fontSize:'45px', fontWeight:'bold'}}>Our Services</h1>
      </div>
    ...
    <p className="service-text" style={{color: '#c89d53'}}>Effortless Case Management</p>
  ...
  <div className="service-section reverse" >
    ...
    <p className="service-text" style={{color: '#c89d53'}}>Transparent Updates, Seamless Experience</p>
  ...
  <div  className="header" style={{ width:"100%" , display:'flex',height:'60vh', alignItems:'center',justifyContent:'center',gap:'3rem',backgroundColor:'#f8f8f8'}}>
    ...
    <div style={{display:'flex',justifyContent:'center',alignItems:'center',flexDirection:'column',width:'60%'}} >
    <p className="service-text" style={{color: '#c89d53'}}>Optimized Workflow & Productivity</p>
...
<div className="team-name">
        <h1 style={{fontFamily:'initial', fontSize:'45px', fontWeight:'bold'}}>Clients Feedback</h1>
      </div>
